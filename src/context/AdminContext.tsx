...
const defaultContentFallback: Record<string, string> = {
  ...
  "method.title": "The Aspire Method",
  "method.subtitle": "Our proven 4-step framework for academic excellence.",
  "method.1.title": "Concept Mastery",
  "method.1.front": "Clear explanation from fundamentals.",
  "method.1.back": "We break down complex topics into easy-to-understand concepts, ensuring students grasp the 'why' behind every formula and theory. True mastery starts here.",
  "method.2.title": "Guided Practice",
  "method.2.front": "Structured problem-solving sessions.",
  "method.2.back": "Students apply concepts immediately through curated worksheets and guided exercises, building muscle memory and confidence for board exams.",
  "method.3.title": "Continuous Testing",
  "method.3.front": "Topic-wise and model exams.",
  "method.3.back": "Over 800 mock papers corrected annually. Regular assessments simulate exam conditions to eliminate fear and build exceptional time-management skills.",
